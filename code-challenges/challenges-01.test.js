...
const greeting = (word) => {
  ...
  let newgreeting = [];
  word.forEach(string => {
    newgreeting.push(string.toUpperCase() + '!')
...
const speaker = (words, callback) => {
  // Solution code here...
  let newSpeaker = [];
  newgreeting.forEach((words, callback) => myCallback(words ,callback ));
newSpeaker.push(myCallback(words ,callback ));
return newSpeaker
